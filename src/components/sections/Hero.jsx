        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 mt-2 leading-tight">Años de experiencia</div>
            </div>
            <div className="text-center">
              <div className="text-3xl lg:text-4xl font-bold text-medical-dark">Especialistas</div>
              <div className="text-sm text-gray-600 mt-2 leading-tight">Profesionales</div>
            </div>
            <div className="text-center">
              <div className="text-3xl lg:text-4xl font-bold text-medical-dark">100%</div>
              <div className="text-sm text-gray-600 mt-2 leading-tight">Dedicación</div>
            </div>
          </div>
        </div>
      </div>
